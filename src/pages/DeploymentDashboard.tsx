...
import PollingExecutionHistory from '@/components/PollingExecutionHistory';
import { Rocket, Code, History, Activity, BarChart3 } from 'lucide-react';
    ...
    <div className="container mx-auto p-6">
      ...
      <Tabs defaultValue="deploy" className="space-y-6">
        <TabsList className="grid w-full grid-cols-4 lg:w-auto lg:inline-flex">
          ...
          <TabsTrigger value="execution-history"><BarChart3 className="w-4 h-4 mr-2" />Execution History</TabsTrigger>
        </TabsList>
