        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Nationwide Cannabis Regulations</p>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Contact federal agencies for questions about cannabis regulations, licensing, and compliance.
                  </CardDescription>
                </CardHeader>
              </Card>
