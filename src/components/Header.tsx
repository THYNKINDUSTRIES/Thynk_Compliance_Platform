      ...
      <div className="bg-black text-white py-2">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between text-sm">
          <div className="flex items-center gap-6">
            <a href="mailto:Info@Thynk.Guru" className="flex items-center gap-2 hover:text-gray-300 transition-colors">
              <Mail className="w-4 h-4" />
              <span className="hidden sm:inline">Info@Thynk.Guru</span>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          {mobileMenuOpen && (
            <nav className="lg:hidden mt-4 flex flex-col gap-3 pb-4 border-t border-gray-700 pt-4">
              ...
              <button className="bg-white text-black hover:bg-gray-200 px-6 py-2 rounded-lg transition-colors font-medium text-left">
                Sign In
              </button>
            </nav>
          )}
