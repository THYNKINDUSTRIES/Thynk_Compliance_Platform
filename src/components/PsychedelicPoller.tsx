...
export const PsychedelicPoller: React.FC = () => {
  ...
  const runPoller = async () => {
    ...
    try {
      const response = await supabase.functions.invoke('psychedelic-poller', {
      ...
      if (data.success) {
        toast({
          title: "Psychedelic Poller Completed",
      ...
      toast({
        ...
        description: 'The psychedelic poller edge function has not been deployed yet. Deploy it via Supabase CLI.',
        variant: "destructive",
      });
    } finally {
      setIsPolling(false);
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Psychedelic Regulatory Poller
        </CardTitle>
        <CardDescription>
          Monitor psilocybin, MDMA, ketamine, and psychedelic therapy regulations across federal and state agencies
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        ...
        <div className="flex gap-2 mb-6">
          <Button onClick={runPoller} disabled={isPolling} className="flex items-center gap-2">
            ...
            {isPolling ? 'Running...' : 'Run Psychedelic Poller'}
          </Button>
        ...
        {isPolling && (
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-2">Processing psychedelic regulations...</p>
          </div>
        )}
            ...
            <ScrollArea className="h-96">
              {recentDocuments.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
                  No psychedelic documents found. Run the poller to fetch regulations.
                </div>
              ) : (
